...
const MatchCard = ({
  ...
  return (
    <Card key={match.id}  className={ roundName === 'round1' ? 'matchCardLeft' : 'matchCardRight' }>
      <CloseOutlinedIcon
      ...
      <div className="playerDiv">
        <div>Player1:</div>
          <TextField
            ...
            variant="standard"
            sx={{ mx: 2, mt: '5px'}}
            onChange={(e) => updateRoundChange(e, match.id, 'name', 0, roundData, setRoundData)}
          ...
          <TextField
            ...
            type="number"
            sx={{ mx: 2, mt: '5px'}}
            onChange={(e) => updateRoundChange(e, match.id, 'score', 0, roundData, setRoundData)}
      ...
      <div className="playerDiv">
        <div>Player2:</div>
          <TextField
            ...
            sx={{ mx: 2, mt: '5px'}}
            onChange={(e) => updateRoundChange(e, match.id, 'name', 1, roundData, setRoundData)}
          ...
          <TextField
            ...
            sx={{ mx: 2, mt: '5px'}}
            onChange={(e) => updateRoundChange(e, match.id, 'score', 1, roundData, setRoundData)}
